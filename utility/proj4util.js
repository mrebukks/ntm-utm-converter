...
const NTM_PROJECTIONS = {
  WEST_BELT: `${MINNA_BASE} +lat_0=4 +lon_0=4.5 +k=0.99975 +x_0=670553.98 +y_0=0`,
  ...
  EAST_BELT: `${MINNA_BASE} +lat_0=4 +lon_0=12.5 +k=0.99975 +x_0=670553.98 +y_0=0`,
};
...
function convertUtmToNtm(utmEasting, utmNorthing, utmZone, ntmBelt) {
  ...
  const [ntmEasting, ntmNorthing] = proj4(sourceProj, targetProj, [utmEasting, utmNorthing]);
